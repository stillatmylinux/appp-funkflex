...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__download_list__ = __webpack_require__(667);
...
var DownloadList = /** @class */ (function () {
    ...
    DownloadList = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"/Users/matt/projects/alphaweb/funkflex/ap3/src/pages/download-list/download-list.html"*/'<ion-header>\n  <ion-toolbar>\n    <ion-title>\n      {{ title | translate }}\n    </ion-title>\n    <ion-buttons end>\n      <button ion-button (click)="dismiss()">\n        <ion-icon name="close"></ion-icon>\n      </button>\n    </ion-buttons>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content>\n\n<ion-list>\n\n  <ion-item-sliding *ngFor="let download of downloads" #slidingItem>\n\n    <button ion-item (click)="mediaModal(download)">\n\n      <h2>{{download.title}}</h2>\n\n    </button>\n\n    <ion-item-options side="right">\n      <button ion-button color="danger" (click)="removeDownload(download)">\n        <ion-icon name="remove-circle"></ion-icon>\n        {{ \'Delete\' | translate }}\n      </button>\n    </ion-item-options>\n\n  </ion-item-sliding>\n\n  <ion-item *ngIf="!downloads">{{ \'No Downloads available.\' | translate }}</ion-item>\n\n</ion-list>\n\n</ion-content>'/*ion-inline-end:"/Users/matt/projects/alphaweb/funkflex/ap3/src/pages/download-list/download-list.html"*/,
