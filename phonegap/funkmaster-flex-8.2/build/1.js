...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__bp_details__ = __webpack_require__(651);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__media_player_media_player__ = __webpack_require__(627);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_video_video_utils__ = __webpack_require__(361);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_buddypress_bp_provider__ = __webpack_require__(359);
...
var BpDetailsPage = /** @class */ (function () {
    function BpDetailsPage(nav, navParams, sanitizer, modalCtrl, renderer, elementRef, viewCtrl, platform, SocialSharing, videoUtils, http, events, bpProvider, toastCtrl, ga, translate) {
        this.nav = nav;
        this.navParams = navParams;
        this.sanitizer = sanitizer;
    ...
    BpDetailsPage.prototype.mediaModal = function (src, img) {
        ...
        var modal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_7__media_player_media_player__["a" /* MediaPlayer */], { source: src, image: img });
        modal.present();
    };
    ...
    BpDetailsPage.prototype.flag = function () {
        ...
        this.bpProvider.updateItem('activity_flag', this.login_data, this.selectedItem.id).then(function (ret) {
            _this.presentToast('Activity has been marked as flagged.');
        }).catch(function (e) {
            console.warn(e);
        });
    };
